...
find "$root_dir" -mindepth 1 -maxdepth 1 -type d | while read -r subdir; do
		...
		find "$subsubdir" -mindepth 1 -maxdepth 1 -type d | while read -r subsubsubdir; do
       		(	
                	...
                	python /home/xj54kovo/work/CFP/project1/script1_1to3/step2/step2_1_1.py
			python /home/xj54kovo/work/CFP/project1/script1_1to3/step2/step2_1_2.py
			python /home/xj54kovo/work/CFP/project1/script1_1to3/step2/recount.py
       		)
		done
        done
done
